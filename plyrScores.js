...
const matches = [
    { name: "League Night - Week 1", games: [185, 201, 192], total: 578, avg: 192.7 },
    { name: "League Night - Week 2", games: [210, 175, 220], total: 605, avg: 201.7 },
    { name: "Tournament Qualifier", games: [230, 245, 205], total: 680, avg: 226.7 },
    { name: "League Night - Week 3", games: [160, 180, 190], total: 530, avg: 176.7 },
    { name: "Friendly Match 1", games: [200, 200, 200], total: 600, avg: 200.0 },
    { name: "League Night - Week 4", games: [205, 195, 215], total: 615, avg: 205.0 },
    { name: "Practice Session A", games: [150, 160, 170], total: 480, avg: 160.0 },
    { name: "League Night - Week 5", games: [190, 220, 185], total: 595, avg: 198.3 },
    { name: "Team Playoffs - QF", games: [225, 230, 210], total: 665, avg: 221.7 },
    { name: "Team Playoffs - SF", games: [180, 190, 190], total: 560, avg: 186.7 },
    { name: "League Night - Week 6", games: [200, 200, 200], total: 600, avg: 200.0 },
];
...
function showMessage(message) {
    ...
    if (!modal) {
        ...
        modal.id = modalId;
        // Tailwind classes for modal backdrop and positioning
